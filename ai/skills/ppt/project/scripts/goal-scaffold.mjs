...
function run() {
  ...
  const errors = SKIP_VALIDATION ? [] : validateGoalSpec(spec, {
  ...
  if (SKIP_VALIDATION) console.warn('DASHI_SKIP_VALIDATION=1: scaffold validation skipped for preview mode');
