...
const SKIP_VALIDATION = /^(1|true|yes)$/i.test(
  String(process.env.DASHI_SKIP_VALIDATION || ''),
);
...
try {
  ...
  const specErrors = SKIP_VALIDATION ? [] : validateGoalSpec(spec);
  ...
  if (SKIP_VALIDATION) console.warn('DASHI_SKIP_VALIDATION=1: render validation skipped for preview mode');
