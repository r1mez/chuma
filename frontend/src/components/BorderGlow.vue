  ...
  >
    ...
    >
      <div
        ...
        style="border: 1px solid transparent; mask: linear-gradient(#fff 0 0) padding-box, linear-gradient(#fff 0 0); mask-composite: exclude; -webkit-mask-composite: xor;"
        :style="{ background: borderBg.join(', ') }"
      />
    </div>
    ...
    <!-- content -->
    <div class="z-[1] relative flex flex-col overflow-auto h-full w-full">
      <slot />
    </div>
  </div>
</template>
